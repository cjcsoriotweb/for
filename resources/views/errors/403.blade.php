...
<body class="min-h-screen bg-gradient-to-br from-red-50 via-orange-50 to-yellow-50 dark:from-gray-900 dark:via-red-900/20 dark:to-orange-900/20 text-gray-900 dark:text-gray-100">
    <div class="flex min-h-screen items-center justify-center p-6">
        <div class="max-w-2xl w-full">
            {{-- Hero Section avec animation --}}
            <div class="text-center mb-8">
                <div class="float-animation mb-6">
                    <div class="w-24 h-24 mx-auto bg-gradient-to-br from-red-500 to-orange-600 rounded-full flex items-center justify-center shadow-2xl">
                ...
                <h1 class="text-6xl font-bold mb-4 bg-gradient-to-r from-red-600 to-orange-600 bg-clip-text text-transparent">
                    403
                </h1>
            ...
            {{-- Card principale --}}
            <div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl border border-white/20 dark:border-gray-700/50 p-8 shadow-2xl">
                {{-- Message d'erreur avec icône --}}
                <div class="text-center mb-8">
                    <div class="inline-flex items-center justify-center w-16 h-16 bg-red-100 dark:bg-red-900/30 rounded-full mb-4 pulse-animation">
                    ...
                    <p class="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
                        ...
                        @else
                            ...
                            <span class="text-sm mt-2 inline-block">Cette page nécessite des permissions spéciales.</span>
                        @endif
                    </p>
                </div>
                ...
                <div class="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
                    <div class="text-center text-sm text-gray-500 dark:text-gray-400">
                        <p>Si vous pensez que c'est une erreur, contactez votre administrateur.</p>
                        <p class="mt-1">Code d'erreur: <span class="font-mono bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded">HTTP_403</span></p>
                    </div>
                </div>
            </div>

            {{-- Éléments décoratifs --}}
            <div class="absolute top-10 left-10 w-20 h-20 bg-gradient-to-br from-red-400/20 to-orange-400/20 rounded-full blur-xl"></div>
            <div class="absolute bottom-10 right-10 w-32 h-32 bg-gradient-to-br from-orange-400/20 to-yellow-400/20 rounded-full blur-xl"></div>
        </div>
    </div>
</body>
</html>
