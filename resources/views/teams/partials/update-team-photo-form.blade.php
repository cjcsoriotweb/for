            ...
            >
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600 dark:text-gray-400">
                            Mettez à jour la photo de votre équipe
                        </p>
                    </div>
                </div>
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    <form
                        ...
                        action="{{
                            route(
                                'application.admin.configuration.photo.update',
                                $team
                            )
                        }}"
                    ...
                    >
                        ...
                        <div class="flex items-center gap-3">
                            <div class="relative">
                                ...
                                <label
                                    for="photo-upload"
                                    class="inline-flex items-center gap-2 px-4 py-2 rounded-md text-sm font-medium bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 border border-gray-300 dark:border-gray-600 hover:bg-gray-200 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 transition cursor-pointer"
                                >
                                    <svg
                                        class="w-4 h-4"
                                        fill="none"
                    ...
                    <form
                        ...
                        action="{{
                            route(
                                'application.admin.configuration.photo.destroy',
                                $team
                            )
                        }}"
                        class="flex-shrink-0"
                ...
                <div class="space-y-2">
                    ...
                    @enderror @if (session('status') === 'team-photo-updated')
                    <div
                    ...
                    @endif @if (session('status') === 'team-photo-removed')
                    <div
                        class="flex items-center gap-2 text-green-600 dark:text-green-400 text-sm"
                    >
                        <svg
