<x-app-layout>
    <div class="min-h-screen bg-gradient-to-br ">
        <div class="py-12">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div
                    class="relative overflow-hidden rounded-3xl bg-gradient-to-r from-indigo-600 via-purple-600 to-indigo-800 shadow-2xl">
                            ...
                            <div class="space-y-6 text-white">
                                ...
                                <div class="space-y-4">
                                    <div class="flex flex-wrap items-center gap-3">
                                        <span
                                            class="inline-flex items-center rounded-full bg-white/20 backdrop-blur-sm border border-white/30 px-4 py-2 text-sm font-semibold text-white">
                                            <div
                                                class="mr-2 h-2 w-2 rounded-full {{ $formation->active ? 'bg-green-400' : 'bg-red-400' }}">
                                            </div>
                        ...
                        <div class="flex justify-center">
                            <div class="w-full max-w-lg flex ">
                                ...
                                <a href="{{ route('formateur.formation.chapters.index', $formation) }}"
                                    class="mr-5 group relative overflow-hidden rounded-2xl border border-slate-200 bg-gradient-to-br from-purple-50 to-purple-100 p-8 transition-all duration-300 hover:shadow-xl hover:shadow-purple-500/10 hover:-translate-y-1 block">
                                    <div
    ...
    <a href="{{ route('formateur.formation.export', ['formation' => $formation, 'format' => 'zip']) }}"
        class="inline-flex items-center rounded-xl bg-emerald-500 backdrop-blur-sm border border-white/30 px-6 py-3 text-sm font-semibold text-white transition-all hover:bg-emerald-500/30 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-indigo-600">
    ...
    @if (Auth::user()->superadmin)
        <a href="{{ route('formateur.formation.delete.show', $formation) }}"
            class="inline-flex items-center rounded-xl bg-red-500 backdrop-blur-sm border border-white/30 px-6 py-3 text-sm font-semibold text-white transition-all hover:bg-red-500/30 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-indigo-600">
            <svg class="mr-2 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
