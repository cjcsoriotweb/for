                            ...
                            <div class="p-8">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <a href="{{ route('formateur.formation.chapters.index', $formation) }}"
                                        class="group relative overflow-hidden rounded-2xl border border-slate-200 bg-gradient-to-br from-green-50 to-emerald-100 p-8 transition-all duration-300 hover:shadow-xl hover:shadow-green-500/10 hover:-translate-y-1 block">
                                        <div
