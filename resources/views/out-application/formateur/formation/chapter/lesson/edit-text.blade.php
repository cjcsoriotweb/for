        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <span class="text-sm text-gray-500 ml-1">Modifier le Contenu Textuel</span>
                            </div>
                        </li>
                    </ol>
                </nav>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form method="POST"
                        action="{{ route('formateur.formation.chapter.lesson.text.update', [$formation, $chapter, $lesson]) }}"
                        ...
                        <div>
                            ...
                            <input type="text" id="content_title" name="content_title"
                                ...
                                placeholder="Ex: Introduction aux concepts fondamentaux" required />
                            @error('content_title')
                        ...
                        <div>
                            ...
                            <textarea id="content_description" name="content_description" rows="2"
                                ...
                                placeholder="Brève description de ce que les apprenants vont apprendre...">{{ old('content_description', $textContent->description) }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea id="content_text" name="content_text" rows="20"
                                ...
                                required>{{ old('content_text', $textContent->content) }}</textarea>
                            @error('content_text')
                                <p class="mt-1 text-sm text-red-600">
                                    {{ $message }}
                                </p>
