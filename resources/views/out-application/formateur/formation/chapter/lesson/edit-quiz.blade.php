          ...
          <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li>
              <div class="flex items-center">
                ...
                <span class="text-sm text-gray-500 ml-1">Modifier le Quiz</span>
              </div>
            </li>
          </ol>
        </nav>
        ...
        <div class="p-6 bg-white border-b border-gray-200">
          ...
          <form method="POST" action="{{
            ...
            <div>
              ...
              <input type="text" id="quiz_title" name="quiz_title" value="{{ old('quiz_title', $quiz->title) }}"
            ...
            <div>
              ...
              <textarea id="quiz_description" name="quiz_description" rows="3"
                ...
                placeholder="Décrivez brièvement le contenu de ce quiz...">{{ old("quiz_description", $quiz->description) }}</textarea>
