      ...
      <div class="bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
        <div class="border-b border-gray-100 bg-gradient-to-r from-indigo-50 to-blue-50 px-6 py-5">
          <div class="flex flex-col gap-3">
            ...
            <div>
              <h1 class="text-2xl font-bold text-gray-900">Modifier le titre de la formation</h1>
              <p class="mt-1 text-sm text-gray-600">
                Actualisez un titre clair et engageant pour vos apprenants.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="p-6">
          <form action="{{ route('formateur.formation.update.title', $formation) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
