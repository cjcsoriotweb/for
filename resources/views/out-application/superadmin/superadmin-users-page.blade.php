                        ...
                        <tr class="transition hover:bg-slate-50/60 dark:hover:bg-slate-800/60">
                            ...
                            <td class="px-6 py-4 text-right">
                                <a
                                    ...
                                    class="inline-flex items-center gap-2 rounded-lg bg-slate-100 px-3 py-2 text-xs font-semibold text-slate-700 transition hover:bg-slate-200 dark:bg-slate-800 dark:text-slate-200 dark:hover:bg-slate-700"
                                >
