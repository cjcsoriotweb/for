@php
    ...
    $sections = [
        [
            'title' => __('Gestion des organisations'),
            'description' => __('Accédez aux espaces de pilotage des équipes et des utilisateurs.'),
            'cards' => [
                [
        ...
        [
            'title' => __('Catalogue & assistants IA'),
            'description' => __('Pilotez les formations et leurs assistants IA associés.'),
            'cards' => [
                [
