            ...
            <div class="flex flex-wrap items-center justify-between gap-4">
                ...
                <div class="flex items-center gap-3">
                    <span
                        ...
                        :class="indicatorClasses[state] ?? indicatorClasses.idle"
                    >
                        ...
                        <div class="flex flex-wrap items-center justify-between gap-3">
                            ...
                            <div class="flex items-center gap-2">
                                <span
                                    ...
                                    :class="badgeClasses[test.status] ?? badgeClasses.idle"
                                    x-text="badgeLabels[test.status] ?? badgeLabels.idle"
                                ></span>
                                <span class="text-xs text-slate-500 dark:text-slate-300" x-show="test.duration">
                                    <span x-text="`${Number(test.duration ?? 0).toFixed(2)}s`"></span>
                                </span>
                            </div>
                        </div>
