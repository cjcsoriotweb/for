          ...
          <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li>
              <div class="flex items-center">
                ...
                <span class="text-sm text-gray-500 ml-1">Ajouter une Vidéo</span>
              </div>
            </li>
          </ol>
        </nav>
        ...
        <div class="p-6 bg-white border-b border-gray-200">
          ...
          <form method="POST" action="{{
            ...
            <div>
              ...
              <input type="text" id="video_title" name="video_title" value="{{ old('video_title') }}"
            ...
            <div>
              ...
              <textarea id="video_description" name="video_description" rows="3"
                ...
                placeholder="Décrivez brièvement le contenu de cette vidéo...">{{ old("video_description") }}</textarea>
            ...
            <div class="space-y-4">
              ...
              <div class="space-y-3">
                ...
                <label
                  ...
                  <input type="radio" name="video_source" value="upload" class="sr-only peer" checked />
                ...
                <label
                  class="relative flex cursor-pointer rounded-lg border bg-white p-4 shadow-sm focus:outline-none border-gray-300 hover:border-indigo-500 transition-colors">
                  <input type="radio" name="video_source" value="url" class="sr-only peer" />
                  <span class="flex flex-1">
                    <span class="flex flex-col">
                      <span class="flex items-center text-sm font-medium text-gray-900">
                        <svg class="w-5 h-5 mr-2 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="text-center">
                  ...
                  <div class="mt-4">
                    <label for="video_file" class="cursor-pointer">
                      <span class="mt-2 block text-sm font-medium text-gray-900">Sélectionner un fichier
                        vidéo</span>
                      <span class="mt-1 block text-sm text-gray-500">MP4, AVI, MOV jusqu'à
                        500MB</span>
