<x-application-layout :team="$team">
    <x-slot name="header">
        <div class="flex items-center space-x-4">
            ...
            <div>
                <h2 class="font-bold text-xl text-white leading-tight">Gestion des utilisateurs</h2>
                <p class="text-blue-100 text-sm">Gérer les utilisateurs de votre plateforme</p>
            </div>
        </div>
    </x-slot>
        ...
        <div class="bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-700 rounded-2xl p-8 text-white">
            <div class="flex items-center justify-between">
                <div class="flex-1">
                    ...
                    <p class="text-blue-100 text-lg mb-6">Administrez les comptes utilisateurs et leurs permissions.</p>
                </div>
                <div class="hidden lg:block">
                    <div class="w-32 h-32 bg-white bg-opacity-10 rounded-full flex items-center justify-center">
                        <span class="material-symbols-outlined text-6xl text-white text-opacity-80">group</span>
                    </div>
                </div>
            </div>
        </div>
