...
<div class="mt-6 rounded-2xl border border-slate-200/70 bg-white p-6 shadow-sm
            dark:border-slate-800/60 dark:bg-slate-900/80 dark:shadow-none">
    <div class="flex items-start gap-3">
        <div class="mt-1 inline-flex h-9 w-9 items-center justify-center rounded-xl
                    bg-indigo-500/10 text-indigo-600 dark:bg-indigo-400/10 dark:text-indigo-300">
            <!-- Icône cadenas -->
            <svg viewBox="0 0 24 24" class="h-5 w-5" fill="none" stroke="currentColor" stroke-width="1.8">
                <path stroke-linecap="round" stroke-linejoin="round"
                    d="M16.5 10.5V7a4.5 4.5 0 10-9 0v3.5M6.75 10.5h10.5a1.5 1.5 0 011.5 1.5v6a1.5 1.5 0 01-1.5 1.5H6.75A1.5 1.5 0 015.25 18v-6a1.5 1.5 0 011.5-1.5z" />
            </svg>
        </div>
    ...
    <div class="mt-5 space-y-4">
        <div>
            ...
            <div class="relative mt-1">
                <x-input
                    ...
                    class="peer block w-full rounded-xl border-slate-300 bg-white/60 py-2.5 pr-12
                ...
                <!-- Bouton afficher/masquer (optionnel, nécessite Alpine si tu veux le rendre interactif) -->
                {{-- <button type="button"
                        class="absolute inset-y-0 right-0 mr-2 inline-flex items-center rounded-lg px-2 text-slate-400
                               hover:text-slate-600 focus:outline-none focus:ring-2 focus:ring-indigo-500/40
        ...
        <div>
            ...
            <x-input
                ...
                required
                autocomplete="new-password"
                class="mt-1 block w-full rounded-xl border-slate-300 bg-white/60 py-2.5
