              ...
              <form method="POST" action="{{
                ...
                <button type="submit"
                  ...
                  <div
                    ...
                    <img src="{{ $application->profile_photo_url }}" alt=""
                    ...
                    <div
                      ...
                      <span
                        class="material-symbols-outlined text-5xl text-slate-400 dark:text-slate-500">business</span>
                    </div>
                    @endif
                  </div>
                  ...
                  <div class="relative z-10">
                    ...
                    <div
                      ...
                      <div class="relative h-full w-full rounded-2xl overflow-hidden">
                        <img src="{{ $application->profile_photo_url }}" alt="{{ $application->name }}"
                    ...
                    <div class="text-center">
                      ...
                      <div
                        ...
                        <span
                          class="material-symbols-outlined text-lg mr-2 transition-transform duration-300 group-hover/btn:scale-110">rocket_launch</span>
              ...
              <div class="relative flex items-center justify-between">
                <div class="flex items-center gap-4">
                  ...
                  <div
                    ...
                    <img src="{{ $invitation->team->profile_photo_url }}" alt="{{ $invitation->team->name }}"
                      class="h-full w-full" style="object-fit: scale-down" />
                    @else
                    <span class="material-symbols-outlined text-xl text-slate-600 dark:text-slate-300">business</span>
                    @endif
                  </div>
