        ...
        <main class="flex-1 relative">
            ...
            <div class="relative mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
                ...
                <div class="mb-16 text-center">
                    ...
                    <h1
                        class="mb-4 text-4xl font-bold tracking-tight text-slate-900 dark:text-white sm:text-5xl"
                    >
                    ...
                    <p
                        class="mx-auto max-w-2xl text-lg text-slate-600 dark:text-slate-300"
                    >
                        {{
                            __(
                ...
                <div class="mb-16">
                    <div class="mb-8 text-center">
                        <h2
                            class="mb-4 text-3xl font-bold text-slate-900 dark:text-white"
                        >
                            {{ __("Vos organismes") }}
                        </h2>
                    ...
                    >
                        ...
                        <div class="group">
                            ...
                            >
                                ...
                                >
                                    <div
                                        class="absolute top-4 left-4 h-2 w-2 bg-blue-400 rounded-full animate-pulse"
                                    ></div>
                                    <div
                                ...
                                <div
                                    class="relative z-10 flex flex-col items-center justify-center h-full min-h-[200px]"
                                >
                                    ...
                                    <div class="mb-6 relative">
                                        ...
                                        >
                                            ...
                                            <!-- Main icon -->
                                            <span
                                                class="material-symbols-outlined text-5xl text-white drop-shadow-lg relative z-10"
                                                >add</span
                                            >
                                        </div>
                                    ...
                                    <div class="text-center">
                                        <h3
                                            class="mb-4 text-2xl font-bold text-slate-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-500"
                                        >
                                        ...
                                        >
                                            <span
                                                class="material-symbols-outlined text-xl mr-2 transition-transform duration-300 group-hover:scale-110"
                                                >search</span
                                            >
                        ...
                        <div class="group">
                            <form
                                method="POST"
                                action="{{
                                    route('application.switch', $application)
                                }}"
                            >
                                @csrf
                                <button
                                ...
                                >
                                    ...
                                    <div
                                        class="absolute inset-0 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 opacity-0 transition-all duration-500 group-hover/btn:opacity-100 dark:from-blue-900/20 dark:via-indigo-900/20 dark:to-purple-900/20"
                                    ></div>

                                    <!-- Subtle pattern overlay -->
                                    <div
                                        class="absolute inset-0 bg-gradient-to-br from-transparent via-transparent to-slate-50/50 opacity-0 transition-opacity duration-500 group-hover/btn:opacity-100 dark:to-slate-800/50"
                                    ></div>

                                    <!-- Centered background logo -->
                                    <div
                                        class="absolute inset-0 flex items-center justify-center opacity-8 group-hover/btn:opacity-15 transition-opacity duration-500"
                                    >
                                        ...
                                        @else
                                        <div
                                            class="h-40 w-40 rounded-2xl bg-gradient-to-br from-blue-400/10 via-purple-500/10 to-indigo-600/10 flex items-center justify-center backdrop-blur-sm"
                                        >
                                            <span
                                                class="material-symbols-outlined text-5xl text-slate-400 dark:text-slate-500"
                                                >business</span
                                            >
                                        </div>
                                        @endif
                                    ...
                                    <div class="relative z-10">
                                        ...
                                        >
                                            ...
                                            <div
                                                class="relative h-full w-full rounded-2xl overflow-hidden"
                                            >
                                                <img
                                                    src="{{ $application->profile_photo_url }}"
                                            ...
                                            <div class="relative">
                                                <div
                                                    class="absolute inset-0 bg-gradient-to-br from-blue-400 via-purple-500 to-indigo-600 rounded-2xl opacity-90 group-hover/btn:opacity-100 transition-opacity duration-500"
                                                ></div>
                                                <div
                                                    class="absolute inset-0 bg-gradient-to-br from-blue-300 via-purple-400 to-indigo-500 rounded-2xl opacity-0 group-hover/btn:opacity-100 transition-opacity duration-500"
                                                ></div>
                                                <div
                                                    class="relative rounded-2xl bg-gradient-to-br from-blue-500 via-purple-600 to-indigo-700 p-4 group-hover/btn:scale-105 transition-transform duration-500"
                                                >
                                                    <span
                                                        class="material-symbols-outlined text-3xl text-white drop-shadow-sm"
                                                        >business</span
                                                    >
                                                </div>
                                                <!-- Pulsing ring effect -->
                                                <div
                                                    class="absolute inset-0 rounded-2xl ring-2 ring-blue-400/30 scale-100 group-hover/btn:scale-110 opacity-0 group-hover/btn:opacity-100 transition-all duration-500"
                                                ></div>
                                            </div>
                                            @endif
                                        </div>
                                        ...
                                        <div class="text-center">
                                            <h3
                                                class="mb-3 text-xl font-bold text-slate-900 dark:text-white group-hover/btn:text-blue-600 dark:group-hover/btn:text-blue-400 transition-colors duration-300 leading-tight"
                                            >
                                                {{ $application->name }}
                                            </h3>
                                            <div
                                                class="flex items-center justify-center text-sm font-medium text-blue-600 dark:text-blue-400 group-hover/btn:text-blue-700 dark:group-hover/btn:text-blue-300"
                                            >
                                                <span
                                                    class="material-symbols-outlined text-lg mr-2 transition-transform duration-300 group-hover/btn:scale-110"
                                                    >rocket_launch</span
                                                >
                                        ...
                                        <div
                                            class="absolute top-4 right-4 opacity-0 transition-all duration-500 group-hover/btn:opacity-100"
                                        >
                                            <div
                                                class="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-blue-500 to-purple-600 text-white"
                                            >
                                                <span
                                        ...
                                        <!-- Bottom accent line -->
                                        <div
                                            class="absolute bottom-0 left-0 h-1 w-full bg-gradient-to-r from-blue-500 to-purple-600 transform scale-x-0 transition-transform duration-500 group-hover/btn:scale-x-100 origin-left"
                                        ></div>
                                    </div>
                                </button>
                            </form>
                ...
                <div class="mb-16">
                    ...
                    >
                        ...
                        >
                            <span
                                class="material-symbols-outlined text-2xl text-amber-600 dark:text-amber-400"
                                >school</span
                            >
                        </div>
                        <h3
                        ...
                        >
                            ...
                            >
                                <span
                                    class="text-sm font-mono text-slate-900 dark:text-slate-100"
                                    >{{ auth()->user()->email }}</span
                                >
                                <button
                                    onclick="navigator.clipboard.writeText('{{ auth()->user()->email }}')"
                ...
                @endif @if ($invitations_pending->count() > 0)
                                ...
                                <div class="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        >
                                            {{
                                                __(
                                                    "vous invite à rejoindre leur organisme"
                                                )
                                            }}
                                        </p>
                                    </div>
