<x-app-layout>
    ...
    <x-slot name="header">
        <div
            class="bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 border-b border-slate-700"
        >
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="relative">
                            ...
                            >
                                <img
                                    src="{{ asset('storage/'.$team->profile_photo_path) }}"
                                    alt="Logo {{ $team->name }}"
                        ...
                        >
                            <span
                                class="material-symbols-outlined text-lg text-white"
                                >{{ $headerIcon ?? "school" }}</span
                            >
                        </div>
                        @endif
                        <div>
    ...
    <x-slot name="header">
        <div
            class="bg-gradient-to-br from-primary-900 via-slate-900 to-slate-800 relative overflow-hidden"
        >
        ...
        >
            <div class="p-6">
                <div class="flex items-start space-x-4">
                    ...
                    <div class="flex-1">
                        <p
                            class="text-slate-700 dark:text-slate-300 leading-relaxed font-medium"
                        >
                            {{ $block }}
                        </p>
                    </div>
