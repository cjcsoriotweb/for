<x-app-layout>
            ...
            <div class="bg-gradient-to-br from-primary-900 via-slate-900 to-slate-800 relative overflow-hidden">
                ...
                <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center space-x-3 text-slate-300 bg-white bg-opacity-5 backdrop-blur-sm rounded-xl px-4 py-2 border border-white border-opacity-10">
    ...
    @isset($block)
        <x-slot name="block">
            <div class="bg-white bg-opacity-80 dark:bg-slate-800 dark:bg-opacity-80 backdrop-blur-sm mx-4 sm:mx-6 lg:mx-8 -mt-8 relative z-10 mb-8 border border-white border-opacity-20 dark:border-slate-700 dark:border-opacity-50 shadow-lg rounded-2xl transition-all duration-300 hover:shadow-xl">
                <div class="p-6">
