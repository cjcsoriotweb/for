    ...
    <body>
        ...
        <div class="min-h-screen flex flex-col">
            ...
            <div class="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8 mt-4">
                <div
                    class="rounded-md bg-green-50 p-4 text-sm text-green-800 dark:bg-green-900/40 dark:text-green-100"
                >
                    {{ session("status") }}
                </div>
            </div>
            ...
            <footer class="border-t border-gray-200 dark:border-gray-800 py-12">
                <div
                    class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex flex-col space-y-4 text-center"
                >
                    <p>
                        <b
                    ...
                    <p>
                        <a
                            href="{{ route('guest.policy') }}"
                            class="text-blue-500 hover:text-blue-700"
                            >{{ __("Mentions légales") }}</a
                        >
                    </p>
                </div>
            </footer>
