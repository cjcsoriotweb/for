<x-app-layout>
            ...
            @foreach ($items as $index => $item)
                <form method="POST" action="{{ route($route, $item) }}"
                    ...
                    <button type="submit"
                        ...
                        <div class="relative rounded-xl overflow-hidden shadow-2xl w-24 h-24 sm:w-36 sm:h-36 md:w-48 md:h-48 lg:w-60 lg:h-60">
    ...
    @else
        <div class="text-center py-16">
            <div class="bg-gradient-to-br from-slate-100 via-blue-50 to-indigo-100 backdrop-blur-lg rounded-3xl p-16 max-w-2xl mx-auto border border-slate-200 shadow-xl">
                <div class="relative mb-8">
                    ...
                    <div class="absolute inset-0 bg-gradient-to-r from-indigo-400/10 to-purple-400/10 rounded-full blur-2xl"></div>
                </div>
                <h3 class="text-slate-800 text-2xl sm:text-3xl font-bold mb-6 bg-gradient-to-r from-slate-700 to-slate-600 bg-clip-text text-transparent">
