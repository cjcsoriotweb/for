<x-organisateur-layout :team="$team">
      ...
      <div
        ...
        <div class="mt-4">
          <a href="{{ route('organisateur.catalogue', $team) }}"
            class="w-full rounded-lg bg-gradient-to-r from-purple-500 to-pink-600 px-4 py-2 text-sm font-medium text-white transition-all hover:from-purple-600 hover:to-pink-700 inline-block text-center">
            Voir les formations
          </a>
        </div>
      </div>
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="mb-8 flex items-center justify-between">
      ...
      <div class="hidden md:block">
        <a href="{{ route('organisateur.catalogue', $team) }}"
          class="rounded-lg bg-gradient-to-r from-blue-500 to-purple-600 px-6 py-3 text-sm font-medium text-white transition-all hover:from-blue-600 hover:to-purple-700 inline-block">
          <svg class="mr-2 inline h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
          </svg>
          Voir toute les formations proposé
        </a>
      </div>
    </div>
