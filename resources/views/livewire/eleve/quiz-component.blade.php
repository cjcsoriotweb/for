      ...
      <ol class="inline-flex items-center space-x-1 md:space-x-3">
        ...
        <li>
          <div class="flex items-center">
            ...
            <span class="ml-1 text-gray-500 md:ml-2 dark:text-gray-400">{{ $chapter->title }}</span>
          </div>
        </li>
        <li aria-current="page">
          <div class="flex items-center">
            ...
            <span class="ml-1 text-blue-600 md:ml-2 dark:text-blue-400">Quiz: {{ $lesson->title }}</span>
          </div>
        </li>
      </ol>
    </nav>
          ...
          <div class="mb-8 pb-8 border-b border-gray-200 dark:border-gray-700 last:border-b-0">
            ...
            <div class="space-y-3">
              ...
              <label
                ...
                <input type="radio" wire:model="answers.{{ $question->id }}" value="{{ $choice->id }}"
                  class="mt-1 text-blue-600 focus:ring-blue-500 focus:ring-2" required />
                <span class="flex-1 has-[:checked]:text-blue-900 has-[:checked]:dark:text-blue-100">
                  {{ $choice->choice_text }}
                </span>
              </label>
              @endforeach
      ...
      <div class="p-6 text-gray-900 dark:text-gray-100">
        <div class="text-center">
          ...
          <div class="flex justify-center space-x-4">
            @if(!$passed && $quiz->max_attempts == 0 || $attempts < $quiz->max_attempts)
              <button x-data="{
                        retryQuiz() {
                            $wire.retryQuiz();
                        }
                    }" x-init="setTimeout(() => retryQuiz(), 1000)" wire:click="retryQuiz"
