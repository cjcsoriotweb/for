        ...
        <div
            ...
            <div class="p-4 bg-white dark:bg-background-dark/50 border-t border-gray-200 dark:border-gray-800">
                <div class="relative flex items-center">
                        ...
                        @if (count($messages) > 5)
                <a wire:click="clean" class="btn bg-red-500 p-5 text-white w-full text-center">Commencer une nouvelle conversation.</a>
                ...
                @else
                    <input
                        ...
                        placeholder="Ask a question about Calculus I..." rows="1" wire:model="input"
