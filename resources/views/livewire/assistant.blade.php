...
@if ($message->is_ia)
    <div class="flex items-end gap-3 p-0">
        ...
        <div class="flex flex-1 flex-col gap-2 items-start">
            <p class="text-[#616f89] dark:text-gray-400 text-[13px] font-normal leading-normal max-w-sm">
                AI Assistant
            </p>
            ...
            <div class="p-4 bg-white dark:bg-background-dark/50 border-t border-gray-200 dark:border-gray-800">
                <div class="relative flex items-center">
                    <input
                        ...
                        placeholder="Ask a question about Calculus I..."
                        rows="1"
                        wire:model="input"
