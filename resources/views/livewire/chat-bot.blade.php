...
<div class="min-h-screen w-full text-slate-100"
    ...
    <div class="mx-auto flex h-screen max-w-4xl flex-col px-4 py-6 sm:px-6 lg:px-0">
        ...
        @elseif (is_null($conversationId))
            <div
                class="flex h-full flex-col overflow-hidden rounded-3xl border border-white/10 bg-white-900/70 p-8 text-white shadow-2xl shadow-slate-900/40 backdrop-blur">
