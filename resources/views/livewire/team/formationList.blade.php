<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div class="mb-12 slide-in-up">
        ...
        <div class="magic-bg rounded-2xl p-6 mt-6">
        ...
        <div class="bg-white dark:bg-slate-800 rounded-xl shadow-elevated border border-slate-200 dark:border-slate-700 card-hover overflow-hidden flex flex-col bounce-in">
            ...
            <div class="p-6 border-b border-slate-100 dark:border-slate-700">
                <div class="flex items-start justify-between mb-3">
                    ...
                    <span class="bg-success-100 text-success-800 dark:bg-success-900/30 dark:text-success-400 text-xs font-semibold px-2.5 py-1 rounded-full flex items-center gap-1 shrink-0">
            ...
            <div class="p-6 flex-1 flex flex-col">
                ...
                <div class="mb-6">
                    ...
                    <div class="w-full bg-slate-200 dark:bg-slate-700 rounded-full h-3 overflow-hidden">
                        <div class="progress-bar-animated bg-gradient-to-r from-success-400 to-success-600 h-3 rounded-full" style="width: {{ $formation->formation_user->progress_percent }}%"></div>
                    </div>
                </div>
                @endif
                ...
                <div class="mt-auto space-y-3">
                    ...
                    <a href="{{ route('application.eleve.formations.continue', [$team, $formation]) }}"
                        class="w-full inline-flex items-center justify-center py-3 px-4 border-2 border-primary-200 dark:border-primary-700 shadow-sm text-sm font-semibold rounded-xl text-primary-700 dark:text-primary-300 bg-primary-50 dark:bg-primary-900/20 hover:bg-primary-100 dark:hover:bg-primary-900/40 focus:outline-none focus:ring-2 focus:ring-primary-500 transition-all duration-200 hover:scale-105">
                    ...
                    <a href="{{ route('application.eleve.formations.preview', [$team, $formation]) }}"
                        class="w-full inline-flex items-center justify-center py-3 px-4 shadow-sm text-sm font-semibold rounded-xl text-white bg-gradient-to-r from-primary-500 to-primary-600 hover:from-primary-600 hover:to-primary-700 focus:outline-none focus:ring-2 focus:ring-primary-500 transition-all duration-200 hover:scale-105 hover:shadow-glow-primary">
