<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-gradient-to-br from-indigo-50 to-blue-50 overflow-hidden shadow-sm sm:rounded-xl border border-indigo-100 mb-8">
                <div class="p-8">
                    ...
                    <div class="flex justify-end">
                        ...
                        >
                            @csrf
                            <button class="inline-flex items-center px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200">
                    ...
                    <div class="text-center py-16">
                        ...
                        <h3 class="text-xl font-medium text-gray-900 mb-2">Aucun chapitre trouvé</h3>
                    ...
                    <div class="grid gap-6">
                        ...
                        <div class="bg-white border border-gray-200 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-200 overflow-hidden">
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center space-x-4">
                                        <div class="flex items-center justify-center w-10 h-10 bg-indigo-100 rounded-full">
                                            <span class="text-indigo-600 font-bold text-sm">{{ $chapter->position }}</span>
                                        </div>
                                    ...
                                    <div class="flex items-center space-x-3">
                                        ...
                                        >
                                            @csrf
                                            <button class="inline-flex items-center px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-medium rounded-lg shadow-sm hover:shadow-md transform hover:-translate-y-0.5 transition-all duration-200">
                                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                                                </svg>
                                                Ajouter une leçon
                            ...
                            <div class="px-6 py-8 text-center">
                                ...
                                <p class="text-gray-500 text-sm">Aucune leçon dans ce chapitre.</p>
                                <p class="text-gray-400 text-xs mt-1">Ajoutez votre première leçon pour commencer.</p>
                            </div>
                            @else
                            <!-- Lessons List -->
                            <div class="p-6">
                                        ...
                                        <div class="flex items-center justify-between">
                                            <div class="flex items-center space-x-4 flex-1">
                                                ...
                                                <div class="flex items-center space-x-2">
                                                    ...
                                                    <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium @if($lesson->lessonable_type === 'App\Models\Quiz') bg-blue-100 text-blue-800 @elseif($lesson->lessonable_type === 'App\Models\VideoContent') bg-green-100 text-green-800 @elseif($lesson->lessonable_type === 'App\Models\TextContent') bg-purple-100 text-purple-800 @else bg-gray-100 text-gray-800 @endif">
                                                        ...
                                                        <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                                            <path fill-rule="evenodd" d="M4 4a2 2 0 00-2 2v8a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2H4zm2 5a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1zm1 3a1 1 0 100 2h6a1 1 0 100-2H7z" clip-rule="evenodd"></path>
                                                        </svg>
                                                        Texte
                                                        @else
