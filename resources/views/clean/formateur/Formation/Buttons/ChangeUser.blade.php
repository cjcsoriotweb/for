          ...
          <a href="{{ route('formateur.formation.completion-documents.index', $formation) }}"
            ...
            <div class="p-6">
              <div class="flex items-center mb-4">
                ...
                <div class="ml-4">
                  <h3
                    class="text-lg font-semibold text-gray-900 group-hover:text-gray-600 transition-colors duration-200">
                    {{ __('Changer responsable de formation ')}}
                  </h3>
                  <p class="text-sm text-gray-600">
                    {{ __("Cette formation est à ") }} {{ App\Models\User::find($formation->user_id)->name }}
                  </p>
                </div>
              </div>
