          ...
          <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li>
              <div class="flex items-center">
                ...
                <span class="text-sm text-gray-500 ml-1">Ajouter du Contenu Textuel</span>
              </div>
            </li>
          </ol>
        </nav>
          ...
          <form method="POST" action="{{
            ...
            <div>
              ...
              <textarea id="content_description" name="content_description" rows="2"
                ...
                placeholder="Brève description de ce que les apprenants vont apprendre...">{{ old("content_description") }}</textarea>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input type="number" id="estimated_read_time" name="estimated_read_time"
                  value="{{ old('estimated_read_time', 10) }}" min="1" max="120"
