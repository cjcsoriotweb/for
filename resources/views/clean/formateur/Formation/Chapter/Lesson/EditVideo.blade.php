                    ...
                    >
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                >{{ old("video_description", $videoContent->description) }}</textarea
                            >
                        ...
                        <div>
                            ...
                            <div class="space-y-3">
                                <label class="flex items-center">
                                    ...
                                    value="url"
                                    {{ old('video_source', $videoContent->video_url ? 'url' : 'upload') === 'url' ? 'checked' : '' }}
                                ...
                                <label class="flex items-center">
                                    <input type="radio" name="video_source"
                                    value="upload"
                                    {{ old('video_source', $videoContent->video_url ? 'url' : 'upload') === 'upload' ? 'checked' : '' }}
                                    class="text-indigo-600
                                    focus:ring-indigo-500"
                                    onclick="toggleVideoSource('upload')" />
                                    <span class="ml-2 text-sm text-gray-700"
                                        >Téléverser un fichier vidéo</span
                                    >
                                </label>
                            </div>
                            @error('video_source')
                        ...
                        <div class="bg-gray-50 rounded-lg p-4">
                            ...
                            <div id="video-preview-container" class="space-y-3">
                                ...
                                >
                                    ...
                                    >
                                        <source
                                            src="{{ asset('storage/' . $videoContent->video_path) }}"
                                            type="video/mp4"
                                        />
                        ...
                        <div>
                            ...
                            <input
                                ...
                                id="video_duration"
                                name="video_duration"
                                value="{{ old('video_duration', $videoContent->duration_minutes) }}"
                                min="1"
                                max="300"
