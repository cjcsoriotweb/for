<div class="bg-white dark:bg-gray-800 shadow rounded-lg">
  ...
  <div class="px-4 py-5 sm:px-6">
      ...
      <div
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
          ...
          <div class="flex items-center gap-2">
            ...
            <span class="text-gray-900 dark:text-white">
              ...
              optional(optional($attempt->lesson->lessonable)->quizQuestions)->count() ?? 0 }}
            </span>
          </div>
        </div>
        ...
        <div class="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
              ...
              <div class="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                <div class="flex-1">
                  ...
                  <p class="mt-2 text-xs italic text-gray-500 dark:text-gray-400">
                    Aucune r&eacute;ponse n'a été sélectionnée pour cette question.
                  </p>
                  @endif
                </div>
                ...
                <span
                  ...
                  {{ $answer->is_correct ? 'Bonne réponse' : 'Réponse incorrecte' }}
                </span>
              </div>

              @if (optional($answer->question)->quizChoices)
              <div class="mt-3 text-xs text-gray-600 dark:text-gray-300">
                <span class="font-medium text-gray-500 dark:text-gray-400">Ré;ponses correctes :</span>
          ...
          <p class="text-sm italic text-gray-500 dark:text-gray-400">
            Aucune réponse n'a été enregistrée pour cette tentative.
          </p>
          @endif
        </div>
      </div>
    ...
    <p class="text-gray-500 dark:text-gray-400">
      Aucune tentative de quiz n'a encore été enregistrée pour cet élève.
    </p>
    @endif
  </div>
</div>