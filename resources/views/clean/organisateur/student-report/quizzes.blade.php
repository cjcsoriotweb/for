<div class="bg-white dark:bg-gray-800 shadow rounded-lg">
  <div class="px-4 py-5 sm:px-6 border-b border-gray-200 dark:border-gray-700">
    ...
    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
      D&eacute;tail des tentatives enregistr&eacute;es pour les &eacute;valuations de la formation.
    </p>
  </div>
  ...
  <div class="px-4 py-5 sm:px-6">
    ...
    <div class="space-y-4">
      ...
      <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-4 transition hover:border-blue-300 dark:hover:border-blue-600 hover:shadow-md">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
          <div class="flex items-center gap-2">
            ...
            <span class="text-gray-900 dark:text-white">
              {{ $attempt->score !== null ? round($attempt->score, 1) : 0 }}%
            </span>
          </div>

          <div class="flex items-center gap-2">
            <span class="font-medium text-gray-500 dark:text-gray-400">Temps pass&eacute; :</span>
            <span class="text-gray-900 dark:text-white">
          ...
          <div class="flex items-center gap-2">
            <span class="font-medium text-gray-500 dark:text-gray-400">R&eacute;ponses :</span>
            <span class="text-gray-900 dark:text-white">
              ...
              <div class="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                <div class="flex-1">
                  <p class="text-sm font-semibold text-gray-900 dark:text-white">
                    {{ optional($answer->question)->question ?? 'Question non trouv&eacute;e' }}
                  </p>

                  @if ($answer->choice)
                  <p class="mt-2 text-xs text-gray-600 dark:text-gray-300">
                    <span class="font-medium text-gray-500 dark:text-gray-400">R&eacute;ponse choisie :</span>
                    <span
                ...
                <span
                  ...
                  <span class="text-base">{{ $answer->is_correct ? '&#10003;' : '&#10007;' }}</span>
                  {{ $answer->is_correct ? 'Bonne r&eacute;ponse' : 'R&eacute;ponse incorrecte' }}
                </span>
              </div>

              @if (optional($answer->question)->quizChoices)
              <div class="mt-3 text-xs text-gray-600 dark:text-gray-300">
                <span class="font-medium text-gray-500 dark:text-gray-400">R&eacute;ponses correctes :</span>
    ...
    <p class="text-gray-500 dark:text-gray-400">
      Aucune tentative de quiz n'a encore &eacute;t&eacute; enregistr&eacute;e pour cet &eacute;l&egrave;ve.
    </p>
    @endif
  </div>
</div>
