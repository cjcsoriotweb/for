      ...
      <div
        ...
        <div class="relative flex items-center justify-between">
          <div>
            ...
            <p class="text-3xl font-bold text-gray-900 dark:text-white">{{ $allFormations->count() }}</p>
            <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Dans le catalogue</p>
          </div>
          <div
      ...
      <div
        ...
        <div class="relative flex items-center justify-between">
          <div>
            ...
            <p class="text-3xl font-bold text-gray-900 dark:text-white">{{ $visibleFormations->count() }}</p>
        ...
        <div class="relative flex items-center justify-between">
          <div>
            ...
            <p class="text-3xl font-bold text-gray-900 dark:text-white">
              {{ $allFormations->avg('money_amount') ? number_format($allFormations->avg('money_amount'), 0, ',', ' ') :
              '0'
              }} €
            </p>
      ...
      <div
        ...
        <div class="relative flex items-center justify-between">
          <div>
            ...
            <p class="text-3xl font-bold text-gray-900 dark:text-white">
              {{ number_format($allFormations->sum('money_amount'), 0, ',', ' ') }} €
            </p>
